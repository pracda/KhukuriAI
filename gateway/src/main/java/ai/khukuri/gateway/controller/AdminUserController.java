package ai.khukuri.gateway.controller;

import ai.khukuri.gateway.exception.GatewayException;
import ai.khukuri.gateway.model.entity.ApiKey;
import ai.khukuri.gateway.model.entity.AuditLog;
import ai.khukuri.gateway.model.entity.GatewayUser;
import ai.khukuri.gateway.model.entity.SecurityAlert;
import ai.khukuri.gateway.model.response.ApiKeyResponse;
import ai.khukuri.gateway.model.response.SecurityAlertResponse;
import ai.khukuri.gateway.repository.AuditLogRepository;
import ai.khukuri.gateway.repository.SecurityAlertRepository;
import ai.khukuri.gateway.repository.UserRepository;
import ai.khukuri.gateway.service.ApiKeyService;
import ai.khukuri.gateway.service.ThreatDetectionService;
